...
class DAttention(nn.Module):
    def __init__(self, in_dim, n_classes, dropout, act):
...
if __name__ == '__main__':
    ...
    model = DAttention(in_dim=512, n_classes=4, dropout=0.25, act="relu").cuda()
    print(model.eval())
    hazards, S, Y_hat, A_raw, _ = model(data)
    print(hazards.shape, S.shape, Y_hat.shape)
